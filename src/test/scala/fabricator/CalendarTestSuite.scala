...
class CalendarTestSuite extends BaseTestSuite {
  ...
  def dayExceptionDP(): Array[Array[Int]] = {
    Array(Array(0, 12), Array(1, 32), Array(32, 10))
  }
  ...
  def dateDP(): Array[Array[Any]] = {
    Array[Array[Any]](
      Array(2014, 2, 30, 0, 0, "28-02-2014 00:00"),
  ...
  def datesRangeDP(): Array[Array[Any]] = {
    Array[Array[Any]](
      Array(2001, 1, 1, 2010, 1, 1, YEARS, 1, 9),
  ...
  def dateWithPeriodDP(): Array[Array[Any]] = {
    Array[Array[Any]](
      Array(0, 0, 0, 0, 0, 0, 0, dd_MM_yyyy_SEMICOLON, DateTime.now.toString(dd_MM_yyyy_SEMICOLON.getFormat)),
      Array(
        1,
        0,
        0,
        ...
        0,
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusYears(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        -1,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusYears(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        1,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusMonths(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        -1,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusMonths(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      ...
      Array(
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusWeeks(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusDays(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusDays(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusHours(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusHours(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusMinutes(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        0,
        0,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusMinutes(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        1,
        1,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusYears(1).plusMonths(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        -1,
        -1,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusYears(1).minusMonths(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        3,
        3,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusYears(3).plusMonths(3).plusWeeks(3).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        -1,
        -1,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusYears(1).minusMonths(1).minusWeeks(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        1,
        1,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.plusYears(1).plusMonths(1).plusWeeks(1).plusDays(1).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        -5,
        -5,
        ...
        0,
        dd_MM_yyyy_SEMICOLON,
        DateTime.now.minusYears(5).minusMonths(5).minusWeeks(5).minusDays(5).toString(dd_MM_yyyy_SEMICOLON.getFormat)
      ),
      Array(
        1,
        1,
        ...
        DateTime.now
          ...
          .plusDays(1)
          .plusHours(1)
          .toString(dd_MM_yyyy_HH_SEMICOLON.getFormat)
      ),
      Array(
        -1,
        -1,
  ...
  def testRelativeDate(
    ...
    format: DateFormat,
    expectedDate: String) = {
    val date = calendar.relativeDate
      .years(year)
      .months(month)
      .weeks(week)
      .days(day)
