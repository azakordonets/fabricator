...
[![Build Status](https://travis-ci.org/azakordonets/fabricator.svg?branch=master)](https://travis-ci.org/azakordonets/fabricator)
...
--------
  ...
  val contact = fabricator.contact() // initialize contact module
